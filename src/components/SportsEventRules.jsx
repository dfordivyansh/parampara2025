  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 sm:p-6">
      ...
      >
        ...
        >
          Rules and Regulations regarding Sports Events
        </motion.h1>
        <motion.ul 
        ...
        >
          ...
          <motion.li whileHover={{ scale: 1.05, color: "#38bdf8" }}>
            When the registration of a group is done in the name of any institute
            or organization, then each member of the group must also belong to
            that particular institute or organization.
          </motion.li>
          <motion.li whileHover={{ scale: 1.05, color: "#38bdf8" }}>
          ...
          <motion.li whileHover={{ scale: 1.05, color: "#38bdf8" }}>
            Any inappropriate behavior towards the judge or volunteer may lead to
...
export default SportsEventRules;