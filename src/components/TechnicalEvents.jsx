...
const events = [
  ...
  },
  {
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSdso4iDvdkDAfHajxhJjzy3rxdZmwSDM-5-G4H7pGpePlJ8vg/viewform",
  },
  {
    name: "Robo Rumble",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSdJTAPoyUILWc2KcjOwcBfsnWBtNE0tJ2VUMBd8iQPhJ3bLcA/viewform",
  },
  {
    name: "Setu Shrishti",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSeHAtBxVagJev3UHL0C59JUowVANwiSWgH-nnDAduimR_Q1FQ/viewform",
  },
  {
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLScuS2Gl4FW8tX4Y3M7bhX8UZMZK0RnW8opGO9hm7m940jRmSA/viewform",
  },
  {
    name: "Junk Yard",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLScuepyxmyPdTd2TF6NSazV3Fs-Uv1jb7lJRY3cozcZuN_U_GQ/viewform",
  },
  {
    name: "Rubik’s Ruckus",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSfa7lDCCVNQLT00T34sOlwRrjK4i_Q7y5ZEzjxAL5FWurreMg/viewform",
  },
  {
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLScF_NPdgbJlOiETkVO_PVp679J2Ud0HbIPUC6nX669kAtNtow/viewform",
  },
  {
    name: "Design Flux",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSfsel9hZuJJKMgBBKTsAFEBwbrZZwkyu-EH2Fe3wNEIpyrT2g/viewform",
  },
  {
    name: "BGMI",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSdbamgXfiH1s9iNR0OoKA55dHqMNX29yyfV6TUijTg8eEjYrg/viewform",
  },
  {
    name: "Riddle Masters",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSdR2_KinPirbmP52rYvZ7GDddQDYbNuY4Ob6GukUVc8sFezyQ/viewform",
  },
  {
    name: "Medi Quest",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSfureGPh3koZGP5GVCxjjMWGuIHXLUx1Rx-DaZj_p3Mjq7mnQ/viewform",
  },
  {
    name: "Lens Master",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSf6jEiNF0zTmXCppqOxi7E8KN21bk3ga4snqenbK8S0TjDpxw/viewform",
  },
  {
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSdvjELnHEooZFoubdiDB3X9Z5spPLC7jVYr0-eQM4jI1qAc_Q/viewform",
  },
  {
    name: "Circuit Design",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSeF_tYv9TQn-TRWXTEE8gHUf09yXNy6meTCtreod8h6Pe4aUQ/viewform",
  },
  {
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSfcHQARKBBxYHa-RyrgYpo0ZqtZttExdVdIti3oBkdFwlyWlg/viewform",
  },
  {
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLScjuoKaQgjTCg8Hvct7WxGVlQXmRYj_1caDo6uRfhl8ZeHrhA/viewform",
  },
  {
    name: "Free Fire",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLScxFOduyvBz_p8G3F728HD5edJvrGEyUv8AsVFsJPpHAIyq7w/viewform",
  },
  {
    name: "Tech Tambola",
    ...
    applyLink: "https://docs.google.com/forms/d/e/1FAIpQLSfExR8HmqsPzX5FW0dmN0YYCGoIaAy8arT3Gr-2v-fw0SDYfA/viewform",
  },
];
  ...
  return (
    <div className="bg-gradient-to-b from-black to-gray-900 min-h-screen flex flex-col items-center py-10 px-5 relative overflow-hidden">
      ...
      <div className="flex flex-col items-center">
        ...
        />
        <div className="text-blue-400 text-5xl font-bold flex items-center gap-2 animate-title">
          <span>⚙️</span> <span className="typing-animation">TECHNICAL EVENTS</span>
        </div>
      </div>
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 z-10">
        {events.map((event, index) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center opacity-0 group-hover:opacity-70 transition-opacity duration-300 p-4">
